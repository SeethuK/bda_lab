...
tf.flags.DEFINE_string("model_path", "C:/Users/Hiresh/Desktop/UMKC/BDAA/coco-caption-master/model/show-and-tell.pb", "Model graph def path")
tf.flags.DEFINE_string("vocab_file", "C:/Users/Hiresh/Desktop/UMKC/BDAA/coco-caption-master/etc/word_counts.txt", "Text file containing the vocabulary.")
tf.flags.DEFINE_string("input_files", "C:/Users/Hiresh/Desktop/UMKC/BDAA/coco-caption-master/imgs/trading_floor.jpg",
...
def main(_):
    ...
    file = open("C:/Users/Hiresh/Desktop/UMKC/BDAA/coco-caption-master/captions.txt", "r")
    id=0
    preimg=""
    dic = []
    res_dic=[]
    for line in file:
        url="C:/Users/Hiresh/Desktop/UMKC/BDAA/coco-caption-master/imgs/"
